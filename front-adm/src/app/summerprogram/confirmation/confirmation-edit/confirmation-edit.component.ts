...
import { ConfirmationEditCustComponent } from '../../../summerprogram-cust/base/confirmation/confirmation-edit.cust.component';
import { ViewType } from '../confirmation.component';
...
@Component({
  ...
  styleUrls: ['./confirmation-edit.component.css']
})
export class ConfirmationEditComponent extends ConfirmationEditCustComponent implements OnInit, AfterViewInit {        
    // @Input() 
    // public id: string;
    // @Input()
