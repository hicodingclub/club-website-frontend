...
const confirmationSubPath = [
    {path: 'list', component: ConfirmationListSubComponent}
];


const spenrollmentDetailPath = [

    {path: 'confirmation', children: confirmationSubPath,
        data: {'mraLevel': 2, 'item': 'confirmation'}},
];


export const spenrollmentRoutingCorePath = [
    {path: 'list', component: SpenrollmentListComponent, canActivate: [AuthGuard]},
    {path: 'detail/:id', component: SpenrollmentDetailComponent, children: spenrollmentDetailPath, canActivate: [AuthGuard]},
...
export const confirmationRoutingCorePath = [
    {path: 'list', component: ConfirmationListComponent, canActivate: [AuthGuard]},
    {path: 'detail/:id', component: ConfirmationDetailComponent, canActivate: [AuthGuard]},
    {path: 'edit/:id', component: ConfirmationEditComponent, canActivate: [AuthGuard]},
    {path: 'new', component: ConfirmationEditComponent, canActivate: [AuthGuard]},
