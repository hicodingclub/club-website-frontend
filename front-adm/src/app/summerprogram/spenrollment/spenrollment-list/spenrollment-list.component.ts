...
import { SpenrollmentListCustComponent } from '../../../summerprogram-cust/base/spenrollment/spenrollment-list.cust.component';
...
export class SpenrollmentListComponent extends SpenrollmentListCustComponent implements OnInit {
  ...
  constructor(
      ...
      public location: Location) {
          super(
                spenrollmentService, injector, router, route, location, ViewType.LIST);
