...
@Directive({
  selector: '[directiveTeachforlifeArrayRequired]',
  providers: [{provide: NG_VALIDATORS, useExisting: DirectiveTeachforlifeArrayRequired, multi: true}]
})
export class DirectiveTeachforlifeArrayRequired implements Validator {
