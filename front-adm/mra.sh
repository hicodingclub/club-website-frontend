hg angular-gen -m emailing -o src/app ../../club-website-backend/models/emailing/model.js
hg angular-gen -m access -o src/app ../../club-website-backend/models/auth/model.access.js
hg angular-gen -m roles -o src/app ../../club-website-backend/models/auth/model.role.js
