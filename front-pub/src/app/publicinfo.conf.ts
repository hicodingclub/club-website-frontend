...
import { generalinfoRoutingPath, faqRoutingPath, eventRoutingPath, keynoteRoutingPath, articleRoutingPath, pageRoutingPath, alertRoutingPath,  } from './publicinfo/publicinfo-routing.path';
